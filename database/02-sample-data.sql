...
-- Insert Sample Users
-- Password is 'password123' hashed with BCrypt (you'll need to update these with actual BCrypt hashes from your app)
...
-- Note: Update user passwords with actual BCrypt hashes after creating users through the application
-- The password hashes above are placeholders and should be replaced with real hashes
